...
#define PMIX_CONFIGURE_CLI " \'--disable-option-checking\' \'--prefix=/u20/hasibih/project/dependencies\' \'--without-tests-examples\' \'--enable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--disable-devel-check\' \'--with-libevent\' \'--disable-libevent-lib-checks\' \'--with-libevent-extra-libs=/u20/hasibih/openmpi-5.0.6/3rd-party/libevent-2.1.12-stable-ompi/libevent_core.la /u20/hasibih/openmpi-5.0.6/3rd-party/libevent-2.1.12-stable-ompi/libevent_pthreads.la\' \'--disable-hwloc-lib-checks\' \'--with-hwloc-extra-libs=/u20/hasibih/openmpi-5.0.6/3rd-party/hwloc-2.7.1/hwloc/libhwloc.la\' \'--with-wrapper-libs=-levent_core -levent_pthreads \' \'CPPFLAGS=-I/u20/hasibih/openmpi-5.0.6/3rd-party/libevent-2.1.12-stable-ompi -I/u20/hasibih/openmpi-5.0.6/3rd-party/libevent-2.1.12-stable-ompi/include -I/u20/hasibih/openmpi-5.0.6/3rd-party/hwloc-2.7.1/include -I/u20/hasibih/openmpi-5.0.6/3rd-party/hwloc-2.7.1/include\' \'--cache-file=/dev/null\' \'--srcdir=.\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Wed Jan 15 22:57:06 UTC 2025"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "grace"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "hasibih"
...
#define PMIX_PACKAGE_STRING "PMIx hasibih@grace Distribution"
